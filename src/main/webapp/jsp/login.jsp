        ...
        <form id="loginForm" action="" method="post" class="form">
            ...
            <div class="body-content">
				...
				<div class="form-group">
                    <div class="checkbox-list">
                        <label>
                            <input type="radio" name="chk" value="商家" onclick="checkRole('shangjia')">&nbsp;商家
                        </label>
                    </div>
                </div>
				...
				<div class="form-group"><button type="button" class="btn btn-success"  style="width: 100%;background-color:var(--publicSubColor, #F37335);color: #FFFFFF;"  onclick="window.location.href='./modules/shangjia/register.jsp'">注册  商家</button></div>
