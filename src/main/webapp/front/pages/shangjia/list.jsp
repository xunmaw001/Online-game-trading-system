                ...
                <div class="ng-inside-box ng-fault ng-container" aos="fade-up">
                    <div>
                        <div v-for="(item,index) in dataList" v-bind:key="index" class="col-md-3 col-sm-3 col-xs-6 w3gallery-grids">
                            <div class="imghvr-hinge-right figure" style="width: 100%" @click="jumpCheck('../shangjia/detail.jsp?id='+item.id , item.aaaaaaaaaa == null?'':item.aaaaaaaaaa , item.shangxiaTypes == null?'':item.shangxiaTypes)">
                                <img :src="item.shangjiaPhoto?item.shangjiaPhoto.split(',')[0]:''" style="height: 350px;width:100%;"/>
                                <div class="agile-figcaption">
                                    <h4>{{item.shangjiaName}}</h4>
                                    <h4 v-if="item.shangjiaNewMoney">
