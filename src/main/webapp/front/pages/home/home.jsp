        ...
        <div class="ng-inmod ng-fault ng-paddor ng-bg-assist">
            <div class="ng-inmod-ini">
                ...
                <div class="ng-incontlst ng-fault ng-container ng-ai-drive1_map" aos="fade-up">
                    <%--<div class="container">--%>
                        <div class="row mb-4">
                            <div v-for="(item,index) in newsList" v-bind:key="index" class="col-lg-3 col-md-6 probootstrap-animate mb-3">
                                <a @click="jumpCheck('../news/detail.jsp?id='+item.id , item.aaaaaaaaaa == null?'':item.aaaaaaaaaa , item.shangxiaTypes == null?'':item.shangxiaTypes)" class="probootstrap-thumbnail">
                                    <img :src="item.newsPhoto?item.newsPhoto.split(',')[0]:''" class="img-fluid" style="height: 350px;width:100%;" />
                                    <h4>
                                        名称:{{item.newsName}}
                                        <br />
                                        <p v-if="item.newsNewMoney != null" >价格:￥{{item.newsNewMoney}}</p>
                                    </h4>
                                </a>
                            </div>
                        </div>
        ...
        <div class="ng-inmod ng-fault ng-paddor ng-bg-assist">
            <div class="ng-inmod-ini">
                ...
                <div class="ng-incontlst ng-fault ng-container ng-ai-drive1_map" aos="fade-up">
                    <%--<div class="container">--%>
                        <div class="row mb-4">
                            <div v-for="(item,index) in shangpinList" v-bind:key="index" class="col-lg-3 col-md-6 probootstrap-animate mb-3">
                                <a @click="jumpCheck('../shangpin/detail.jsp?id='+item.id , item.aaaaaaaaaa == null?'':item.aaaaaaaaaa , item.shangxiaTypes == null?'':item.shangxiaTypes)" class="probootstrap-thumbnail">
                                    <img :src="item.shangpinPhoto?item.shangpinPhoto.split(',')[0]:''" class="img-fluid" style="height: 350px;width:100%;" />
                                    <h4>
                                        名称:{{item.shangpinName}}
                                        <br />
                                        <p v-if="item.shangpinNewMoney != null" >价格:￥{{item.shangpinNewMoney}}</p>
                                    </h4>
                                </a>
                            </div>
                        </div>
        ...
        <div class="ng-inmod ng-fault ng-paddor ng-bg-assist">
            <div class="ng-inmod-ini">
                ...
                <div class="ng-incontlst ng-fault ng-container ng-ai-drive1_map" aos="fade-up">
                    <%--<div class="container">--%>
                        <div class="row mb-4">
                            <div v-for="(item,index) in shangjiaList" v-bind:key="index" class="col-lg-3 col-md-6 probootstrap-animate mb-3">
                                <a @click="jumpCheck('../shangjia/detail.jsp?id='+item.id , item.aaaaaaaaaa == null?'':item.aaaaaaaaaa , item.shangxiaTypes == null?'':item.shangxiaTypes)" class="probootstrap-thumbnail">
                                    <img :src="item.shangjiaPhoto?item.shangjiaPhoto.split(',')[0]:''" class="img-fluid" style="height: 350px;width:100%;" />
                                    <h4>
                                        名称:{{item.shangjiaName}}
                                        <br />
                                        <p v-if="item.shangjiaNewMoney != null" >价格:￥{{item.shangjiaNewMoney}}</p>
                                    </h4>
                                </a>
                            </div>
                        </div>
