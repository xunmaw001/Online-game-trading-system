        ...
        <div class="ng-inmod ng-fault ng-paddor ng-bg-fff">
            <div class="ng-inmod-ini">
                ...
                <div class="ng-inside-box ng-fault ng-container" aos="fade-up">
                    <div>
                        <div v-for="(item,index) in dataList" v-bind:key="index" class="col-md-3 col-sm-3 col-xs-6 w3gallery-grids">
                            ...
                            <div class="imghvr-hinge-right figure" style="width: 100%" @click="jumpCheck('../shangpin/detail.jsp?id='+item.shangpinId , item.shangpinDelete == null?'':item.shangpinDelete , item.shangxiaTypes == null?'':item.shangxiaTypes)">
                                <img :src="item.shangpinPhoto?item.shangpinPhoto.split(',')[0]:''" style="height: 350px;width:100%;"/>
                                <div class="agile-figcaption">
                                    <h4>{{item.shangpinName}}</h4>
                                    <h4 v-if="item.shangpinNewMoney">
