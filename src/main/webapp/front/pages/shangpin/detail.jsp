                ...
                <div class="blog-details-wrapper">
                    ...
                    <div class="blog-details-header">
                        ...
                        <ul class="post-meta">
                            ...
                            <li >
                                <button @click="clikcShanjia"  type="button" class="layui-btn" style="background-color: var(--publicMainColor,orange);">
                                    查看商家
                                </button>
                            </li>
                        </ul>
...
<script>
    ...
    var vue = new Vue({
        ...
        methods: {
            ...
            clikcShanjia() {
                jump("../shangjia/detail.jsp?id="+this.detail.shangjiaId);
            }
        }
    });
