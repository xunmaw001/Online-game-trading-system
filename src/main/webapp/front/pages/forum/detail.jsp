...
<body>
    ...
    <div id="app">
        ...
        <div v-if="detail.shangjiaId" class="auth-container">
            发布人{{detail.shangjiaName}}&nbsp;&nbsp;&nbsp;发布人权限：商家&nbsp;&nbsp;&nbsp;时间：{{detail.insertTime}}
        </div>
        <div v-if="detail.usersId" class="auth-container">
            ...
            <div class="message-list">
                <div class="message-item" v-for="(item,index) in dataList" v-bind:key="index">
                    ...
                    <div v-if="item.shangjiaId" class="username-container">
                        <img class="avator" :src="item.shangjiaPhoto">
                        <span class="username">商家：{{item.shangjiaName}}</span>
                    </div>
